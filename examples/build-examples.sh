...
compile_example "esp32:esp32:esp32" "../examples/tests/buffers/*"
compile_example "esp32:esp32:esp32" "../examples/tests/callback/*"
compile_example "esp32:esp32:esp32" "../examples/tests/codecs/*"
compile_example "esp32:esp32:esp32" "../examples/tests/collections/*"
