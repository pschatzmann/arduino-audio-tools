...
#include "minimp3_tables.h"

#define MINIMP3_MAX_SAMPLES_PER_FRAME (1152*2)
//#define TRACE() LOGD(__FUNCTION__)
#define TRACE()
...
#if defined(__ARM_ARCH) && (__ARM_ARCH >= 6) && !defined(__aarch64__) && !defined(_M_ARM64) && !defined(ARDUINO_ARCH_RP2040)
#define HAVE_ARMV6 1
