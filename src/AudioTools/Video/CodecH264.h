 ...
 * any write() call, not just at flush()). flush() is VideoOutput's no-op
 * default - some producers (e.g. DemuxerAVI/DemuxerMP4) call it
 * unconditionally after each frame, but this class has nothing to do with
 * it.
 *
